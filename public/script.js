...
document.addEventListener('DOMContentLoaded', function() { 
    ...
    if (contactForm) { 
        contactForm.addEventListener('submit', async function(e) { 
            ...
            if (!window.zappyContactFormLoaded || window.zappyContactFormLoaded) {
                try {
                    ...
                    const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                        ...
                        body: JSON.stringify({
                            websiteId: 'c5c02e2b-c06a-4358-9c63-ad922f06733e',
                            name: data.name || '',
                            email: data.email || '',
            ...
            formMessage.textContent = 'תודה על פנייתך! ניצור איתך קשר בהקדם.'; 
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "קנדלייט משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
